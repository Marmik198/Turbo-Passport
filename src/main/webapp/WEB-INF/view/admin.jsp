...
<body>
    ...
    <nav class="navbar navbar-expand-sm">
        ...
        <div class="logo">
            <a href="#"><span class="logoin"><b>Turbo Passport (Admin)</b></span></a>
        </div>
    ...
    <div class="section section-white no-bottom-padding" id="Services">
        ...
        <div class="container-1">
            ...
            <div class="b">
                <p class="grid-item"> <a href="/admin/viewPassportApplications">Verify Applications</a></p>
            </div>
            <div class="c">
                <p class="grid-item"><a href="/home">Admin Logout</a></p>
            </div>
        </div>
    </div><br><br>
