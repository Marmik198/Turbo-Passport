	  ...
	  <p style="text-align:left;font-size:25px;margin-top:30px">Enter your acknowledgment id and use the dropdown-menu below to choose the type of crime reported .</p>
		...
		<br>
	  	...
	  	<br>
		   ...
		   <label style="font-size:22px;font-weight:bold"for="complaints">Choose the type of application:</label>
		   <br>
	  <select class="input-complaint id="complaints" name="complaintType" size="3">
		    <option style="padding:10px" value="1">Fresh Passport Application</option>
		    <option style="padding:10px" value="2">Passport Renewal Application</option>
		    <option style="padding:10px" value="3">Visa Application</option>
		</select>
	  <br><br>
